...
# TODO
- [] кейс, где число отрицательное
- [] кейс, где айди кошелька не строка
- [] проверка на наличие кошелька перед использованием session.merge
- [] нет проверки на провальное подключение к ДБ
- [] баланс кошелька не залочен
- [] нет логирования ошибок

- [] тест на кейс с 1000 RPS
- [] докер для апи и ДБ
- [] проверить покрытие эндпоинтов тестами